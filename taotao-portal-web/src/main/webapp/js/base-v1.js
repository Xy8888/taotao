 ...
 */
function login() {
    return location.href = "http://www.taotao.com/page/login.shtml";
}
function regist() {
    return location.href = "http://www.taotao.com/page/register.shtml";
}
...
function search(a) {
    var b = "http://search.taotao.com/search.shtml?q=" + encodeURIComponent(document.getElementById(a).value);
